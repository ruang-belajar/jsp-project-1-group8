...
<html>
<head>
    <title>Message Board - Reza</title>
...
<body class="bg-light">
    <div class="container mt-5">
        <div class="text-center mb-4">
            <img src="gambar/reza.jpg" alt="Reza" class="rounded-circle" style="width:150px;">
            <h2 class="mt-3">Message Board - Reza</h2>
        </div>

        <div class="card mb-4">
            <div class="card-body">
                <form method="post" action="reza.messageboard.jsp">
                    <div class="mb-3">
